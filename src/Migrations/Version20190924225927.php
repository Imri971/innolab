 ...
 */
final class Version20190924225927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, alias VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_8D93D649A0A1C920 FOREIGN KEY (programmes_id) REFERENCES programmes (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
