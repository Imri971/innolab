 ...
 */
final class Version20190925192001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, programmes_id, email, roles, password, name, alias, tel, adress FROM user');
        ...
        $this->addSql('INSERT INTO user (id, programmes_id, email, roles, password, name, alias, tel, adress) SELECT id, programmes_id, email, roles, password, name, alias, tel, adress FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, alias VARCHAR(255) DEFAULT NULL, tel INTEGER DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, programmes_id, email, roles, password, name, alias, tel, adress) SELECT id, programmes_id, email, roles, password, name, alias, tel, adress FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
        $this->addSql('CREATE INDEX IDX_8D93D649A0A1C920 ON user (programmes_id)');
